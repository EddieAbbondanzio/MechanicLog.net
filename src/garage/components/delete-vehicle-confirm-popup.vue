<template>
    <b-modal title="Delete Vehicle Confirmation" ref="popup">
        <div class="text-center">
            <h3>Are you sure?</h3>

            <p class="text-muted">
                This action cannot be undone, and the vehicle will be gone forever.
 ...
 */
@Component({
    name: 'delete-vehicle-confirm-popup',
})
export default class DeleteVehicleConfirmPopup extends Vue {
    /**
