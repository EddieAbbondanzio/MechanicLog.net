<template>
    <b-modal title="Delete Maintenance Confirmation" ref="popup">
        <div class="text-center">
            ...
            <p
                class="text-muted"
            >This action cannot be undone, and the maintenance record will be permanently deleted.</p>
        </div>
 ...
 */
@Component({
    name: 'delete-maintenance-popup',
})
export default class DeleteMaintenancePopup extends Vue {
    /**
