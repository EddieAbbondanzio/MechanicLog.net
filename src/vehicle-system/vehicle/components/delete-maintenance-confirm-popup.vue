<template>
    <b-modal title="Delete Maintenance Confirmation" ref="popup">
        <div class="text-center">
            <h3>Are you sure?</h3>

            <p class="text-muted">
                This action cannot be undone, and the maintenance record will be gone forever.
            </p>
        </div>
 ...
 */
@Component({
    name: 'delete-maintenance-confirm-popup',
})
export default class DeleteMaintenanceConfirmPopup extends Vue {
    /**
