  ...
  <div class="row">
    <div class="col-12">
      <div style="position: relative">
        ...
        <div class="text-white" style="position: absolute; left: 10%; top: 20%; right: 10%;">
          ...
          <div class="mt-5">
            <button type="button" class="btn btn-primary btn-lg mr-2">Login</button>
...
/**
 * Large hero image for showing something off.
 */
@Component({
  name: 'hero',
})
